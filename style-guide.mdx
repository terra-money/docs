...
Use writing to show off a subject. Don't use a subject to show off your writing.
...
The Terra docs are structured using the [Diataxis framework](https://diataxis.fr/). This framework outlines the four distinct modes of documentation:
