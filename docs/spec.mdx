...
## 3. Update `ibc` and `packetfowardingmiddleware` from v3 to v6
...
- [Terra Core v2.3.0 PR](https://github.com/terra-money/core/pull/106)
- [Terra Core v2.3.0 release](https://github.com/terra-money/core/releases/tag/v2.3.0)
