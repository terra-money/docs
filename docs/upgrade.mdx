...
1. [Cosmos SDK v0.46.x](https://github.com/cosmos/cosmos-sdk/blob/release/v0.46.x/CHANGELOG.md) contains endpoint changes. Developers will need to [update the endpoints listed in the section below](#endpoint-changes). [New endpoints are available](#new-endpoints) with the addition of the Alliance and TokenFactory modules. 
