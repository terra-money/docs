...
The Terra Core will be upgraded at the blockcheight `4711800`, as specified in the [Core Upgrade Governance Proposal](https://station.station.money/proposal/phoenix-1/4717). After passing, the chain will halt at the specified height, and validators will need to update their nodes. Once updated, the chain will start again. This process may take some time as this is a major upgrade. 
