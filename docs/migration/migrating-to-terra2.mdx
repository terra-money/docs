...
### 5. station.js changes.

Outside of the deprecation of the treasury, market, and oracle modules, station.js functionality remains relatively unchanged. There are a few additions to allow for legacy commands which are explained in [Using Terra Classic](../develop/station-js/terra-classic.mdx).

<Admonition type="danger" icon="🔥" title="Update station.js and Wallet Provider">

All dApps on the new Terra chain must update [@terra-money/station.js](https://www.npmjs.com/package/@terra-money/station.js) and [@terra-money/wallet-provider](https://www.npmjs.com/package/@terra-money/wallet-provider) to the latest versions.
