...
You can view your vesting Luna in Terra Station by using the [Vesting guide](../learn/terra-station/vesting.mdx).
...
For more information, see how to [use Terra.js with Terra Classic](../develop/terra-js/terra-classic.mdx). 
...
It will be up to each team whether the their tokens will be supported on the new chain. Each token team will have to relaunch the token to the new chain with a snapshot.
