...
### Does station.js need to be upgraded?

Yes, there will be a new release of station.js. However, the interface will not change significantly.
For more information, see how to [use station.js with Terra Classic](../develop/station-js/terra-classic.mdx).
