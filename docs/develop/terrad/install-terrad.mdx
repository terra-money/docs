...
Before proceeding, make sure your Go path is set up correctly. 

1. Open your Bash profile in your code editor. If you use VS Code, you can run the following command to open the file. 
