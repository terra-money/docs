...
The easiest way to install Terrad and Terra Core is by downloading a pre-built Linux binary. You can find the latest binaries on the [releases page](https://github.com/terra-money/core/releases). 

Mac users should follow the instructions below. 
...
Then run the _`version`_ command again:
