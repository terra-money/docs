# terrad query staking redelegations
...
## Example
terrad query staking redelegation terra1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p

```sh Terrad
terrad query staking redelegations [delegator-addr] [flags]
```
