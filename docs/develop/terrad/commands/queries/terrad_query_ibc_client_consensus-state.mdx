# terrad query ibc client consensus-state
...
```sh Terrad
terrad query ibc client consensus-state [client-id] [height] [flags]
```

### Examples

```sh Terrad
terrad query ibc client  consensus-state [client-id] [height]
```
