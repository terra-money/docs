## terrad query ibc channel client-state
...
```
terrad query ibc channel client-state [port-id] [channel-id] [flags]
```

### Examples

```
terrad query ibc channel client-state [port-id] [channel-id]
```
