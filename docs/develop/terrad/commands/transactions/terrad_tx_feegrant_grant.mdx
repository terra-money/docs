...
The `--from` flag is ignored in this command, as it is implied from `[granter]`.
...
```sh Terrad
terrad tx feegrant grant terra1skjw... terra1skjw... --spend-limit 100stake --expiration 2022-01-30T15:04:05Z or

terrad tx feegrant grant terra1skjw... terra1skjw... --spend-limit 100stake --period 3600 --period-limit 10stake --expiration 36000 or

terrad tx feegrant grant terra1skjw... terra1skjw... --spend-limit 100stake --expiration 2022-01-30T15:04:05Z 
...
```sh Terrad
terrad tx feegrant grant [granter_key_or_address] [grantee] [flags]
```
