...
```sh Terrad
terrad tx authz grant <grantee> <authorization_type="send"|"generic"|"delegate"|"unbond"|"redelegate"> --from <granter> [flags]
```

## Example

```sh Terrad
terrad tx authz grant terra1skjw.. generic --msg-type=/cosmos.gov.v1beta1.MsgVote --from=terra1sk..
```
...
```sh Terrad
 terrad tx authz grant terra1skjw.. send /cosmos.bank.v1beta1.MsgSend --spend-limit=1000stake --from=terra1skl..
...
```sh Terrad
  ...
  -b, --broadcast-mode string        Transaction broadcasting mode (sync|async|block) (default "sync")
      ...
      --expiration int               The Unix timestamp. Default is one year. (default 1709329777)
