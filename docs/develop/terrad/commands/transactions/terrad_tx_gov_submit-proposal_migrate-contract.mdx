# terrad tx gov submit-proposal migrate-contract
...
```sh Terrad
terrad tx gov submit-proposal migrate-contract [contract_addr_bech32] [new_code_id_int64] [json_encoded_migration_args] [flags]
```
