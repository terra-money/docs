# terrad tx ibc-fee pay-packet-fee
...
```sh Terrad
terrad tx ibc-fee pay-packet-fee [src-port] [src-channel] [sequence] [flags]
```

## Example

```sh Terrad
terrad tx ibc-fee pay-packet-fee transfer channel-0 1 --recv-fee 10stake --ack-fee 10stake --timeout-fee 10stake
```
