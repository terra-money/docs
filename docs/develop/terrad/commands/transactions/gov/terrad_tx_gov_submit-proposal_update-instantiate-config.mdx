# terrad tx gov submit-proposal update-instantiate-config
...
```sh Terrad 
terrad tx gov submit-proposal update-instantiate-config 1,nobody 2,everybody 3,terra1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm
...
```sh Terrad
terrad tx gov submit-proposal update-instantiate-config [code-id,permission]... [flags]
```
