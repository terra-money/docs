# terrad tx gov submit-legacy-proposal execute-contract

Submit an execute wasm contract proposal (run by any address). 

```sh Terrad
terrad tx gov submit-legacy-proposal execute-contract [contract_addr_bech32] [json_encoded_migration_args] [flags]
```
