...
The Terra Station extension is a web-wallet extension for Chrome or Firefox that enables webpages to create requests for signing and broadcasting transactions. The webpage can detect the presence of the Terra Station Extension and generate a prompt whereby the user can confirm and sign transactions.

## Wallet Provider

Wallet Provider is a library that simplifies the development of React dApps that utilize Terra Station extension or Terra Station mobile.
