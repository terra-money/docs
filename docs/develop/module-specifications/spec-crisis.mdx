...
Terra's crisis module inherits from the Cosmos SDK's [`crisis`](https://docs.cosmos.network/main/modules/crisis) module. This document is a stub and mainly covers important Terra-specific notes on how it is used.
