...
Terra's distribution module inherits from Cosmos SDK's [`distribution`](https://docs.cosmos.network/main/modules/distribution/) module. This document is a stub and mainly covers important Terra-specific notes on how it is used.
