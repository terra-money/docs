...
Passive distribution means that validators and delegators need to manually collect their fee rewards by [submitting withdrawal transactions](../terrad/commands/transactions/distribution/terrad_tx_distribution_withdraw-rewards.mdx). 
