...
Proposals start as ideas within the community on Terra's [Agora forum](https://agora.terra.money/). After gaining support and feedback from the community, a proposer [drafts and submits a proposal](../../learn/terra-station/governance.mdx#create-a-new-proposal) alongside an [initial deposit](../../learn/terra-station/governance.mdx#deposit-luna-to-a-proposal). 
