...
Terra's Governance module inherits from Cosmos SDK's [`gov`](https://docs.cosmos.network/main/modules/gov/) module. This document is a stub, and mainly covers important Terra-specific notes on how it is used.
...
Proposals start as ideas within the community on Terra's [Agora forum](https://agora.station.money/). After gaining support and feedback from the community, a proposer [drafts and submits a proposal](../../learn/station/governance.mdx#create-a-new-proposal) alongside an [initial deposit](../../learn/station/governance.mdx#deposit-luna-to-a-proposal).
...
The minimum number of votes needed for a proposal to be valid. As of [Terra governance prop 3547](https://station.station.money/proposal/3547), 30% of all staked Luna must vote to reach `Quorum`.
