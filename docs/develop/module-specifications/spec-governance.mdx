...
The minimum number of votes needed for a proposal to be valid. As of [Terra governance prop 3547](https://dashboard.station.money/proposal/3547), 30% of all staked Luna must vote to reach `Quorum`.
