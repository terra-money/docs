...
Terra's upgrade module inherits from the Cosmos SDK's [`upgrade`](https://docs.cosmos.network/main/modules/upgrade/) module. This document is a stub and mainly covers important Terra-specific notes on how it is used.
