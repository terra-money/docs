...
The Terra Core is organized into the following individual modules that implement different parts of Terra. They are listed in the order in which they are initialized during genesis:
