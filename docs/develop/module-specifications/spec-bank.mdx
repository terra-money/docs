...
Terra's bank module inherits from the Cosmos SDK's [`bank`](https://docs.cosmos.network/main/modules/bank/) module. This document is a stub and mainly covers important Terra-specific notes on how it is used.
