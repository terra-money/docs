...
Terra's evidence module inherits from Cosmos SDK's [`evidence`](https://docs.cosmos.network/main/modules/evidence/) module. This document is a stub and mainly covers important Terra-specific notes on how it is used.
