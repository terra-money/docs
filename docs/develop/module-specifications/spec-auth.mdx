...
Terra's auth module inherits from Cosmos SDK's [`auth`](https://docs.cosmos.network/main/modules/auth/) module. This document is a stub and mainly covers important Terra-specific notes on how it is used.
