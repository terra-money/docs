...
Terra's mint module inherits from the Cosmos SDK's [`mint`](https://docs.cosmos.network/main/modules/mint/) module. This document is a stub and mainly covers important Terra-specific notes on how it is used.
