...
Use the following common examples to learn how to use feather.js. If this is your first time using feather.js, follow the [feather.js tutorial](./getting-started.mdx).

<Admonition type='tip' icon='💡'>

If you are new to developing on Terra visit the [getting started guide](../../../docs/develop/get-started.mdx).
