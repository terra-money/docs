...
Feather.js is a fork of terra.js with multi-chain capabilities. It can be used to interact with cosmos blockchains like Terra within JavaScript runtimes, such as Node.js and the browser. feather.js enables the following functionalities:
...
- New [configuration syntax](./common-examples.html#configuring-lcdclient) for LCDClient to support multiple chains.
- Need to [specify the chainID](./common-examples.html#sending-native-tokens) when creating or broadcasting a transaction.
