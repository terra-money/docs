...
4. Request testnet funds for your wallet by navigating to the [Terra faucet](https://faucet.station.money) and inputting your wallet address. You'll need these funds to perform swaps and pay for gas fees. Once the funds are in your wallet, you’re ready to move on to the next step.
