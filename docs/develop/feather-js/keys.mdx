...
- [ `RawKey` ](https://github.com/terra-money/feather.js/blob/main/src/key/RawKey.ts)
- [ `MnemonicKey` ](https://github.com/terra-money/feather.js/blob/main/src/key/MnemonicKey.ts)
- [ `CLIKey` ](https://github.com/terra-money/feather.js/blob/main/src/key/CLIKey.ts)

You can also create a custom signing solution by extending the base [ `Key` ](https://github.com/terra-money/feather.js/blob/main/src/key/Key.ts) class.
...
As per the [Cosmos HD Key Derivation](https://github.com/confio/cosmos-hd-key-derivation-spec) spec:
...
- Coin Type Numbers `330` and `118` above refer to 'coin-types' for the `Terra` and `Cosmos` blockchains respectively. These numbers are defined according to the [BIP044](https://github.com/bitcoin/bips/blob/master/bip-0044.mediawiki) standard. You can find more information [here](https://github.com/satoshilabs/slips/blob/master/slip-0044.md).
