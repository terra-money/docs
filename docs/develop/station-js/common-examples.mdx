...
## Configuring InterchainLCDClient

The following code example shows how to initialize the InterchainLCDClient. The rest of the examples assume you initialized it by using this example or similar code. You must also specify the prefix of the chain you'd like to connect to.
...
```ts
import { InterchainLCDClient, Tx } from '@terra-money/station.js';
