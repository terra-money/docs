...
To perform actions using an account and private-public key pairs with station.js, you need an implementation of the [ _Key_ ](https://github.com/terra-money/station.js/blob/main/src/key/Key.ts) class, which provides an abstraction around the signing functions of an account. There are multiple implementations available:

- [ _RawKey_ ](https://github.com/terra-money/station.js/blob/main/src/key/RawKey.ts)
- [ _MnemonicKey_ ](https://github.com/terra-money/station.js/blob/main/src/key/MnemonicKey.ts)
- [ _CLIKey_ ](https://github.com/terra-money/station.js/blob/main/src/key/CLIKey.ts)

You can also create a custom signing solution by extending the base [ _Key_ ](https://github.com/terra-money/station.js/blob/main/src/key/Key.ts) class.
...
```ts
import { RawKey } from '@terra-money/station.js';
