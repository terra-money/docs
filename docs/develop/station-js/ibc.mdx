...
Terra has full IBC transfer capabilities through both station.js and Terra Station.
...
Instructions for initializing InterchainLCDClient can be found [here](https://docs.terra.money/docs/develop/sdks/station-js/common-examples.html#configuring-InterchainLCDClient).
