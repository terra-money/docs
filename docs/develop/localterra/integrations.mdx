...
Station has built-in support for LocalTerra for quick and easy interaction. [Open Station](https://station.terra.money/) and switch to the `Localterra` network.
