...
LocalTerra is often used alongside [station.js](../station-js/README.mdx) or [Terra.py](../terra-py/get-started-py.mdx) scripting as it is a convenient environment in which to run integration tests. LocalTerra also allows developers to speed up the block time to improve the development experience.
