...
Localterra may not perform optimally on machines with less than 16 GB of RAM. Please use the [Pisco testnet](./using-terrain-testnet.mdx) if your device does not meet this requirement.
