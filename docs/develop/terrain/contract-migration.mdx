...
This tutorial uses [Terrain](./README.mdx), a Terra development suite designed to simplify the scaffolding, deployment, and migration of smart contracts. 

If this is your first time using Terrain, visit the [Terrain setup](./initial-setup.mdx) guide. 
