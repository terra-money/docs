...
- [Terra Station Chrome extension](../../learn/station/download/station-extension.mdx)
...
1. Open the [Terra Station Chrome extension](https://chrome.google.com/webstore/detail/station-wallet/aiifbnbfobpmeekipheeijimdpnlpgpp), click the gear icon in the upper right-hand corner, and switch the network to LocalTerra.
