...
- [Install the Terra Station Chrome extension](../../learn/station/download/station-extension.mdx)

## Create a test wallet

Open the Terra Station browser extension and [create a new wallet](../../learn/station/download/station-extension.mdx#create-a-wallet) for testing purposes. It is recommended that you name this wallet "Pisco" or "testnet" so that it's easy to remember.
...
1. In the Terra Station Chrome extension, [switch the network to `testnet`](../../learn/station/networks.mdx).
