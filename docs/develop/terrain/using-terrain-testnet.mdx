...
After creating a test wallet and storing the seed phrase, request funds from [the testnet faucet](https://faucet.station.money) in order to have tokens to carry out transactions on testnet.
