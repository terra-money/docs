...
- [Install the Terra Station browser extension](../../learn/terra-station/download/terra-station-extension.mdx)

## Create a Pisco wallet

[Create a new wallet](../../learn/terra-station/download/terra-station-extension.mdx#create-a-wallet) using the Terra Station extension. It's recommended that you name this wallet "Pisco" or "testnet" so it's easy to remember.
...
1. In the Terra Station Chrome extension, [switch the network to `testnet`](../../learn/terra-station/testnet.mdx).
