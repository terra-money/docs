...
Visit [build Terra Core](../../../full-node/run-a-full-terra-node/build-terra-core to install the latest version of Terra Core to obtain a working version of Terrad. You will need this to connect to your local Terra test network to work with smart contracts.
