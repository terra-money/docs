...
Terra.py is no longer being maintained, and you may encounter errors from using this unsupported tool. Please use [feather.js](https://github.com/terra-money/feather.js) instead. Generally, migration from Terra.py to Feather.js can be done relatively easily. Follow the [Feather.js tutorial](../feather-js/getting-started.mdx) to learn how to get started. 
