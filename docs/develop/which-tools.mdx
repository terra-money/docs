...
│
│ // link[5:12] ./station-js/getting-started
├── station.js: JavaScript SDK.
│
...
Use station.js to create bots, mint NFTs, and build out back-end services. Follow the [station.js tutorial](station-js/getting-started.mdx) to get started.
