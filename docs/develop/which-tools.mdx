...
└── Other tools
    ...
    │
    │ // link[9:14] https://finder.station.money
    ├── Finder: Block explorer.
    │
    │ // link[9:14] https://faucet.station.money
...
Terra’s multi-purpose [block explorer](https://finder.station.money/).

#### Faucet <ThemedImage sources={{light:"/img/icons/Faucet.svg", dark:"/img/icons/dark/Faucet.svg"}} height="20px" />

Get tokens sent to your testnet address using the [Terra Testnet Faucet](https://faucet.station.money).
