...
├── Terra.py: Python SDK.
│
│ // link[5:19] ./wallet-provider/wallet-provider-tutorial
├── Wallet Provider: React tooling for frontend integrations.
│
└── Other tools
    │
    │ // link[9:14] ./terrad/install-terrad
...
Use Terra.js to create bots, mint NFTs, and build out back-end services. Follow the [Terra.js tutorial](terra-js/getting-started.mdx) to get started.
...
Wallet Provider makes it easy to connect a React-based web app to Terra Station. There are multiple [templates](https://templates.terra.money/) available for front-end frameworks like Vue, React, and Vite. Follow the [Wallet Provider tutorial](wallet-provider/wallet-provider-tutorial.mdx) to get started.
