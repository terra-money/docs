...
Multisig wallets are an advanced feature of Terra Station. If you’re using Terra Station for the first time, follow the [Terra Station tutorial](download/station-desktop.mdx).
...
- Download the [Terra Station browser extension](download/station-extension.mdx)
