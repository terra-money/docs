...
You can send tokens from your wallet to another using Station's **Send** feature. If this is your first time using Station, follow the [Station tutorial](download/station-desktop.mdx) to learn more.

1. Open Station and connect to your wallet.

2. Click on the **Wallet** tab on the right side of your screen. Then click **Send**.
