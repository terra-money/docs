...
You can send tokens from your wallet to another Terra wallet utilizing the **Send** feature in Terra Station. If this is your first time using Terra Station, follow the [Terra Station tutorial](Download/station-desktop.mdx) to learn more.
