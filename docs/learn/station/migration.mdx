...
## Use Terra Classic on Station Wallet: Legacy

1. Export your Private key:

    - For Extension users: Open your extension and click on your wallet name in the navigation bar. Then click on the three dots and then select **Export Wallet**.

    - For Desktop users: Open Station desktop and click on your wallet name in the navigation bar. Then click  **Export Wallet**.
...
3. Open the Station Classic app and select **Import wallet**.
