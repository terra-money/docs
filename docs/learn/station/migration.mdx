...
2. Click **Import from seed phrase**.

<img className="readme-img-sm" src="/img/screens/extension/connect.png" />

3. Enter a name, password, and your previous Station seed phrase.

<img className="readme-img-sm" src="/img/screens/extension/import.png" />
...
Ledger wallets can only be accessed using the Station extension and [Station web app](https://station.station.money).
...
4. Navigate to the [Station web app](https://station.station.money) in your browser and Click **Connect**. Then select **Access with ledger**.
