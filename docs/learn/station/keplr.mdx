...
<img className="readme-img-md" src="/img/screens/keplr/import.png" />
3. Enter the seed phrase from your Station wallet, create an account name, and enter
a password.

<img className="readme-img-md" src="/img/screens/keplr/input.png" />

4. Confirm your password and click **Next**.

5. Click **Done**.

<img className="readme-img-md" src="/img/screens/keplr/done.png" />
