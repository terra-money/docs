...
3. Enter the seed phrase from your Station wallet, create an account name, and enter
a password.
...
2. Click **Unlock** and your wallet will popup. Follow the next steps to access Terra on your wallet.
...
Congratulations, you can now use Terra with Keplr!
