...
Governance is an important part of being involved in the Terra community. This tutorial walks you through how to vote on and submit governance proposals in Station. For more information on governance and voting options, check out [the governance overview](../protocol.mdx#governance).
