...
Users can vote on a proposal after a minimum token deposit is reached (e.g. 512 for Terra). To help push a proposal forward to a vote, you may deposit tokens into the proposal.
...
Before uploading any proposal, try to get community feedback on [the Terra Agora research forum](https://agora.terra.money) or the respective forum on the proposal you're creating.
...
3. Select the type of proposal, enter a title, a description, and the amount of tokens you will offer for initial deposit.

4. Enter your password and click **Submit**.

Your proposal will enter the two-week deposit period. After the minimum deposit has been reached (512 Luna for Terra), the proposal will enter a one-week voting period. For more information on governance and voting options, visit the [governance overview](../protocol.mdx#governance).
