...
For more guides on how to use the advanced features of Terra Station, visit the [Terra Station guides](../../station).
...
1. Open the Terra Station desktop app and click **Stake**.
...
To begin using any of the various dApps the Terra ecosystem has to offer, check out the [Terra Station Chrome extension](station-extension.mdx) or the [Terra Station Firefox extenstion](station-firefox.mdx). For on-the-go transactions, check out the [Terra Station mobile app](station-mobile.mdx).

For more guides on how to use other Station features, visit the [Terra Station guides](../../../learn/station).
