...
To learn how to view vesting Luna in your wallet, visit the [Terra Station vesting guide](./station/vesting.mdx).
...
To learn how to vote with your staked Luna or submit proposals, visit the [Terra Station governance guide](./station/governance.mdx).
