...
To learn how to view vesting Luna in your wallet, visit the [Terra Station vesting guide](./terra-station/vesting.mdx).
...
To learn how to stake your Luna and earn staking rewards, visit the [Terra Station staking guide](terra-station/staking.mdx)
...
<Admonition type="caution" title="Who owns staked Luna?">
...
Delegators can bond Luna to any validator in the [active set](./glossary.mdx#active-set) using the delegate function in Terra Station. Delegators start earning staking rewards the moment they bond or stake to a validator.
...
- [Inflation rewards](../module-specifications/spec-mint.mdx): Every block, new Luna is minted and released to validators and delegators as staking rewards. The rate for the minting of this new Luna is fixed at 7% per year. 
...
<Admonition type="danger" title="The risks of staking">
...
For more information on slashing, visit the [slashing module](../module-specifications/spec-slashing.mdx).
...
To learn how to vote with your staked Luna or submit proposals, visit the [Terra Station governance guide](./terra-station/governance.mdx).

### Proposals

Proposals start as ideas within the community on Terra's [Agora forum](https://agora.terra.money/). After gaining support and feedback from the community, a proposer [drafts and submits a proposal](./terra-station/governance.mdx#create-a-new-proposal) alongside an [initial deposit](./terra-station/governance.mdx#deposit-luna-to-a-proposal).
...
The following is a basic outline of the governance process. Visit the [governance module](../module-specifications/spec-governance.mdx) for more details.
