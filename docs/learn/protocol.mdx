...
Proposals start as ideas within the community on Terra's [Agora forum](https://agora.station.money/). After gaining support and feedback from the community, a proposer [drafts and submits a proposal](./station/governance.mdx#create-a-new-proposal) alongside an [initial deposit](./station/governance.mdx#deposit-luna-to-a-proposal).
