...
For more information on fees, visit [Fees on Terra](fees.html).
...
A section of the Terra Core that represents a particular function of the Terra protocol. Visit the [Terra Core module specifications](/module-specifications) for more information.
...
For more information, see [slashing](/learn/protocol.html#slashing) in the description of the Terra protocol.
...
For more information on staking, visit the [concepts page](/learn/protocol.html#staking).
...
For more information on the Terra Core, see [Terra Core modules](/module-specifications).
...
To learn how to install and get started using Terra Station, visit the [Terra Station tutorial](/learn/terra-station/download).

To learn how to use the advanced features of Terra Station, visit the [Terra Station how-to guide](/learn/terra-station/wallet.html).

## terrad

The command line interface for interacting with a Terra node.

For more information on terrad, see [`terrad` guides](/develop/terrad).
...
A copy of the mainnet network used for testing. The testnet does not use real tokens. You can use the testnet to get familiar with carrying out transactions on Terra. The current testnet for Terra is [`pisco-1`](/develop/endpoints.html).
...
For more information on validators, visit the [concepts page](/learn/protocol.html#validators).
