...
A section of the Terra core that represents a particular function of the Terra protocol. Visit the [Terra core module specifications](../module-specifications/README.mdx) for more information.
...
For more information on the Terra core, see [Terra core modules](../module-specifications/README.mdx).
...
To learn how to install and get started using Terra Station, visit the [Terra Station tutorial](./terra-station/download/README.mdx).
...
A version of the mainnet just for testing. The testnet does not use real coins. You can use the testnet to get familiar with transactions. The current testnet for Terra is [`pisco-1`](../endpoints.mdx)
