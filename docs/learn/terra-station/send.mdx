...
You can send tokens from your wallet to another Terra wallet utilizing the **Send** feature in Station. If this is your first time using Station, follow the [Station tutorial](Download/station-desktop.mdx) to learn more.
