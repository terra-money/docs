...
You can send tokens to other Terra wallets using the **Send** feature of Terra Station. If this is your first time using Terra Station, follow the [Terra Station tutorial](./download/terra-station-desktop.mdx).
