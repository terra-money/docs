...
This guide is for advanced features of the Terra Station wallet. If this is your first time using Terra Station, follow the [Terra Station tutorial](./download/terra-station-desktop.mdx).

For information on using multisig wallets in Terra Station, visit [the Station multisig guide](./multisig.mdx).
