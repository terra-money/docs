...
This tutorial will guide you through using the advanced features of the Terra Station wallet. If this is your first time using Terra Station, follow the [Terra Station tutorial](Download/terra-station-desktop.mdx).

For information on using multisig wallets in Terra Station, visit the [multisig wallet tutorial](./multisig.mdx).
...
### Import your private key from another Station wallet
...
Your wallet is now deleted. You may regain access to your wallet by supplying your [seed phrase](#recover-a-wallet-using-a-seed-phrase) or [private key and password](#connect-to-a-wallet-using-a-private-key) in Terra Station.
