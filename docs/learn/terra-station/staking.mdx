...
This tutorial walks you through how to manage your staking delegations in Terra Station. To learn how to stake or withdraw rewards, check out the Terra Station [desktop](Download/terra-station-desktop.mdx) or [mobile](Download/terra-station-mobile.mdx) tutorials.  

If this is your first time using Terra Station, follow the [Terra Station tutorial](Download/terra-station-desktop.mdx) to learn more.
