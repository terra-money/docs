...
- [The Terra Station browser extension](../terra-station/download/terra-station-extension.mdx) for tokens on the Terra blockchain.
- A wallet on the chain you want to bridge. 


<Admonition type="tip" title="Paying for fees">
...
<img style={{padding: '1rem'}} src='/img/screens/wormhole/source.png' />
...
<img style={{padding: '1rem'}} src='/img/screens/wormhole/target.png' />
...
<img style={{padding: '1rem'}} src='/img/screens/wormhole/send.png' />
