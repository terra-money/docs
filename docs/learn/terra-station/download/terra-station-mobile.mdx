...
Rewards start accruing the moment you stake your Luna. Monitor your rewards in the **STAKE** section of your Terra Station mobile app. Once you have sufficient rewards, follow the below steps to withdraw them.
...
To use Terra Station on your computer, visit the [Terra Station desktop tutorial](./terra-station-desktop.mdx). To learn how to use other Station features, visit the [Terra Station guides](../README.mdx).
