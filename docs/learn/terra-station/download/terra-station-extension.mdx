...
<img style={{padding: '1rem'}} src='/img/screens/ext-new-wallet.png' />
...
<img style={{padding: '1rem', width: 500}} src='/img/screens/ext-wallet-input.png' />

7. Confirm your seed phrase by typing or selecting the correct words in each prompt.

<img style={{padding: '1rem', width: 500}} src='/img/screens/ext-confirm.png' />

8. Click **Submit**.

9. Click **Connect** to connect to your new wallet.

<img style={{padding: '1rem', width: 500}} src='/img/screens/ext-wallet-complete.png' />
...
<img style={{padding: '1rem', width: 500}} src='/img/screens/ext-wallet.png' />

2. Purchase tokens using your preffered exchange.

<img style={{padding: '1rem', width: 500}} src='/img/screens/ext-wallet-buy.png' />
...
<img style={{padding: '1rem', width: 500}} src='/img/screens/ext-wallet-menu.png' />
