...
For on-the-go transactions, check out the [Terra Station mobile app](./terra-station-mobile.mdx). To learn how to use other Station features, visit the [Terra Station guides](../README.mdx).
