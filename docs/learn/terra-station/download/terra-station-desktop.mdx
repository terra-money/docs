...
<img className="readme-img-lg" style={{padding: '1rem'}} src='/img/screens/desktop/connect.png' />
...
6. Verify your writing to make sure every word is spelled correctly and in the right order. If you numbered your phrase, it can be helpful to verify it backward.

7. Check the box ensuring you wrote down your seed phrase, and click **Submit**.
<img className="readme-img-lg" style={{padding: '1rem'}} src='/img/screens/desktop/new-wallet.png' />

8. Confirm your seed phrase by typing or selecting the correct words in each prompt.

9. Click **Submit**, then click **Connect**.
<img className="readme-img-lg" style={{padding: '1rem'}} src='/img/screens/desktop/seed.png' />

<img className="readme-img-lg" style={{padding: '1rem'}} src='/img/screens/desktop/wallet.png' />
...
<img className="readme-img-lg" style={{padding: '1rem'}} src='/img/screens/desktop/stake-page.png' />

3. In the **My delegations** section, click **Delegate**. A new window will appear.

<img className="readme-img-sm" style={{padding: '1rem'}} src='/img/screens/desktop/stake-validator.png' />

4. In the **Amount** field, specify the amount of Luna you want to delegate and specify which coin you want to pay fees with. 

<img className="readme-img-lg" style={{padding: '1rem'}} src='/img/screens/desktop/stake-delegate.png' />
...
<img className="readme-img-lg" style={{padding: '1rem'}} src='/img/screens/desktop/send-wallet.png' />
...
<img className="readme-img-lg" style={{padding: '1rem'}} src='/img/screens/desktop/send-submit.png' />
