...
<img style={{padding: '1rem'}} src='/img/screens/desktop/connect.png' />
...
<img style={{padding: '1rem'}} src='/img/screens/desktop/new-wallet.png' />

8. Confirm your seed phrase by typing or selecting the correct words in each prompt.

9. Click **Submit**, then click **Connect**.
<img style={{padding: '1rem'}} src='/img/screens/desktop/seed.png' />

<img style={{padding: '1rem'}} src='/img/screens/desktop/wallet.png' />
...
<img style={{padding: '1rem'}} src='/img/screens/desktop/stake-page.png' />


3. In the **My delegations** section, click **Delegate**. A new window will appear.

<img style={{padding: '1rem'}} src='/img/screens/desktop/stake-validator.png' />

4. In the **Amount** field, specify the amount of Luna you want to delegate and specify which coin you want to pay fees with. 

<img style={{padding: '1rem'}} src='/img/screens/desktop/stake-delegate.png' />
...
<img style={{padding: '1rem'}} src='/img/screens/desktop/send-wallet.png' />
...
<img style={{padding: '1rem'}} src='/img/screens/desktop/send-submit.png' />
