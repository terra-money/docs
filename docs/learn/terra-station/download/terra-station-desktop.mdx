...
For more guides on how to use the advanced features of Terra Station, visit the [Terra Station guides](../README.mdx).
...
Rewards start accruing the moment you stake your Luna. Monitor your rewards in the staking section of Terra Station. Once you have sufficient rewards, follow the below steps to withdraw them.
...
For more guides on how to use other Station features, visit the [Terra Station guides](../README.mdx).
