...
In this tutorial, you will learn how to create a new wallet on the Terra Station Firefox extension. To connect to an existing wallet, you may view the instructions on how to [recover a wallet](../wallet.md#connect-to-a-wallet-using-a-private-key).
