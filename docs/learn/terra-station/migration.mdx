...
- Download the [Station Chrome extension](Download/terra-station-extension.mdx) and [create a wallet](Download/terra-station-extension.mdx#create-a-wallet).
- Make sure you have access to your seed phrase.

## Import an existing Station wallet

To access other chains on Station you'll need to re-add your wallet.

If you do not re-add your wallet, you will still have access to the private key and funds associated with your wallet, but you will not be able to interact with other chains.
...
3. Enter your wallet's mnemonic seed phrase.
...
5. Congratulations, now you can access your interchain funds!
