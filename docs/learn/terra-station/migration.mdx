...
To access other chains on Station you'll need to re-add your wallet. If you choose not to, you will still have access to the private key and funds associated with your wallet but you will not be able to interact with other chains.

<Admonition type="caution" icon="ℹ️">

Station needs to derive your wallet address for each chain from the same mnemonic seed phrase. Station must reload the mnemonic seed phrase in order to detect tokens held in wallets that were created via the `118` derivation path. For more info on mnemonic seed phrases, visit the [Keys page](../../../docs/develop/feather-js/keys.mdx#mnemonickey).
...
<img className="readme-img-sm" src="/img/screens/extension/recover-success.png" />
...
Congratulations! Now you can access funds on your ledger with Station. 
