...
Multisig wallets are an advanced feature of Terra Station. If you’re using Terra Station for the first time, follow the [Terra Station tutorial](Download/terra-station-desktop.mdx).
...
- Download the [Terra Station browser extension](Download/terra-station-extension.mdx)
