...
Claims all the streams that the sender receives from.
...
Revokes previosuly given permission of the `spender` to send or transfer a stream's cw721. For more info, check out [the cw721 docs](https://github.com/CosmWasm/cw-nfts/blob/main/packages/cw721/README.md#messages). 
