...
When the writer is finished, they can post the finished manuscript (in plaintext or pdf). Final versions are appended with  _`"is_final": true,`_.
...
View the details of a submitted proposal.
