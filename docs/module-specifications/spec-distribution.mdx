...
Passive distribution means that validators and delegators need to manually collect their fee rewards by [submitting withdrawal transactions](../develop/terrad/subcommands.mdx#tx-distribution-withdraw-rewards).
