...
9. To sync your Phoenix mainnet node from block 4,711,800 to the most recent block, you will need to navigate to the `core` directory and change your terrad version to `v2.3.0`.
...
The result of this command should be `v2.3.0`.
