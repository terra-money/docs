...
<Admonition type="tip" title="Just want to dive in?">
...
<details><summary> Getting `polyfill` errors? </summary>
<p>
...
<Admonition type="note" title="What happens if something goes wrong?">
